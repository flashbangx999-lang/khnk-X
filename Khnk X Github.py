...
#
# Field yang bisa diisi per baris:
#   "text"          : (wajib) isi liriknya
#   "typing_speed"  : (opsional) delay per karakter, detik.
#                      Kalau tidak diisi -> pakai CONFIG["typing_speed"]
#   "line_pause"    : (opsional) jeda setelah baris ini selesai diketik,
#                      detik. Kalau tidak diisi -> pakai CONFIG["line_pause"]
#
# Contoh: bikin baris tertentu diketik lebih pelan & jeda lebih lama
# (misal buat penekanan dramatis), atau lebih cepat & jeda pendek
# (buat baris yang terasa "buru-buru" / emosional).
# =========================================================
LYRICS = [
    {
    ...
    {
        "text": "I was trying to be someone",
        "typing_speed": 0.10,
        "line_pause": 0.70,
    },
]
...
def _fake_neofetch():
    ...
    info = [
        ("User", os.environ.get("USER", "richky") + "@khnkx"),
